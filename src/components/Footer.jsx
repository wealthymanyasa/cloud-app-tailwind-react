...
const Footer = () => {
  const currentYear = new Date().getFullYear();
    return (
        <div id="footer" className="w-full mt-34 bg-slate-900 text-gray-300 py-6 px-2">
            ...
            <div className="flex flex-col justify-between items-center px-2 py-4 mx-auto text-center text-gray-500 max-w-[1240px] sm:flex-row ">
                <p className="pt-4 text-white">{currentYear} <a href="http://obertmanyasa.web.app" target="_blank" rel="noreferrer" className="hover:text-indigo-600 cursor-pointer hover:cursor-pointer">Codestar</a>, LLC. All rights reserved</p>
